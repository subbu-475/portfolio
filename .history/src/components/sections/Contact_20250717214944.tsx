          ...
          <div className="space-y-8">
            <div className="animate-fade-in-up">
              ...
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                ...
                a fellow developer, a potential client, or someone with a great idea, 
              ...
              <div className="grid grid-cols-1 gap-4">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className="flex items-center space-x-4 p-4 glass-effect rounded-lg hover:shadow-glow-primary transition-all duration-300 group"
                  >
                    <social.icon className={`w-6 h-6 text-muted-foreground ${social.color} transition-colors group-hover:scale-110`} />
                    <div>
                      <div className="font-medium group-hover:text-primary transition-colors">
                        {social.name}
                      </div>
