...
import { Code, Database, Server, Smartphone, CircuitBoard, TerminalSquare} from 'lucide-react';
...
const skills = [
  ...
  { name: 'Flutter', level: 75, icon: CircuitBoard, color: 'text-cyan-400' },
            ...
            <div className="mt-6 glass-effect p-6 rounded-lg">
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  'Git', 'GraphQL', 'REST APIs', 'Tailwind CSS',"Flutter"
                ].map((tech) => (
                  <span
                    key={tech}
