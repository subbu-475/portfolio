...
const skills = [
  ...
  { name: 'Express.js', level: 85, icon: Server, color: 'text-gray-400' },
  { name: 'React Native', level: 75, icon: Smartphone, color: 'text-cyan-400' },
];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Passionate developer with 2 years of experience creating scalable web applications
          </p>
        </div>
          ...
          <div className={`space-y-6 ${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`}>
            <div className="glass-effect p-8 rounded-lg">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  Hello! I'm Alex, a passionate MERN Stack Developer with over 2 years of 
